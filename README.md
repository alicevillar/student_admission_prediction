...
> In this project, I applied a resampling technique (oversampling) to the imbalanced dataset and compare the performance of different Machine Learning models
